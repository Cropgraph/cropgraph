...
| Asset | Detail |
|-------|--------|
| Crop calendar | 2,000 entries: 643 vegetables, 449 fruits, 383 herbs, 194 flowers, 162 legumes, 96 cover crops, 75 roots. Frost-anchored planting windows with optional climate modifiers for six climate types. Named cultivars across tomato, pepper, apple, grape, blueberry, raspberry, strawberry, pear, peach, plum, melon, watermelon, bean, pea, corn, squash, lettuce, carrot, onion, garlic. |
| Companion planting | 605 directed relationships: 510 beneficial, 95 antagonist, 12 mechanism categories (nitrogen_fixing, pest_repellent, trap_crop, ...). Deep coverage of fruit-tree guilds, cover-crop succession, native pollinator pairings, and cultivar-level disease antagonism. |
